        ...
        <div>
            <section className="relative h-screen flex items-center">
                ...
                <div className="relative z-20 text-white text-center mx-auto">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">DSAT.sigma</h1>
                    <p className="text-lg sm:text-xl md:text-2xl">The ultimate platform for Digital SAT testing</p>
                </div>
                {/* Fade-out overlay */}
                <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-gray-900 to-transparent pointer-events-none"></div>
                <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white text-center">
                    <p className="text-lg mb-2">SIGMA</p>
                </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row items-center justify-center py-20 max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                <div className="md:w-1/2">
                    ...
                    <p className="text-lg">
                        DSAT.sigma, the cutting-edge digital SAT testing platform that leverages artificial intelligence
                        to create personalized practice questions tailored to your strengths and weaknesses. Our AI-driven
                        system ensures you receive the most relevant and challenging questions to maximize your preparation.
                        With user-friendly navigation, real-time feedback, and comprehensive performance analytics, DSAT.sigma
                        is your ultimate partner in achieving SAT success!
                    </p>
                </div>
                {/* Right column */}
